...
class MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.resourceWidgetContents = QtWidgets.QStackedWidget(parent=self.dockWidgetContents_3)
        self.resourceWidgetContents.setContentsMargins(0, 0, 0, 0)
        self.resourceWidgetContents.setAcceptDrops(True)
        self.gridLayout_3.addWidget(self.resourceWidgetContents, 1, 0, 1, 7)
        ...
        self.resourceWidgetContents.addWidget(self.resourceList)
        self.resourceListPlaceholder = QtWidgets.QWidget(parent=self.dockWidgetContents_3)
        self.resourcePlaceholderLayout = QtWidgets.QVBoxLayout(self.resourceListPlaceholder)
        self.resourcePlaceholderLayout.addStretch()
        self.resourcePlaceholderIcon = QtWidgets.QLabel()
        self.resourcePlaceholderIcon.setPixmap(QtGui.QIcon.fromTheme("edit-drop").pixmap(128, 128))
        self.resourcePlaceholderIcon.setAlignment(QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.resourcePlaceholderLayout.addWidget(self.resourcePlaceholderIcon)
        self.resourcePlaceholderText = QtWidgets.QLabel()
        self.resourcePlaceholderText.setAlignment(QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.resourcePlaceholderText.setWordWrap(True)
        self.resourcePlaceholderBody = QtWidgets.QLabel()
        self.resourcePlaceholderBody.setAlignment(QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.resourcePlaceholderBody.setWordWrap(True)
        self.resourcePlaceholderLayout.addWidget(self.resourcePlaceholderText)
        self.resourcePlaceholderLayout.addWidget(self.resourcePlaceholderBody)
        self.resourcePlaceholderLayout.addStretch()
        self.resourceWidgetContents.addWidget(self.resourceListPlaceholder)
        self.resourceWidgetNoPage = QtWidgets.QWidget()
        self.resourceWidgetContents.addWidget(self.resourceWidgetNoPage)
        ...
        self.actionAlignLeft = QtGui.QAction(parent=MainWindow)
        icon = QtGui.QIcon.fromTheme("align-horizontal-left")
        self.actionAlignLeft.setIcon(icon)
        self.actionAlignLeft.setObjectName("actionAlignLeft")
        self.actionAlignTop = QtGui.QAction(parent=MainWindow)
        icon = QtGui.QIcon.fromTheme("align-vertical-top")
        self.actionAlignTop.setIcon(icon)
        self.actionAlignTop.setObjectName("actionAlignTop")
        self.actionAlignRight = QtGui.QAction(parent=MainWindow)
        icon = QtGui.QIcon.fromTheme("align-horizontal-right")
        self.actionAlignRight.setIcon(icon)
        self.actionAlignRight.setObjectName("actionAlignRight")
        self.actionAlignBottom = QtGui.QAction(parent=MainWindow)
        icon = QtGui.QIcon.fromTheme("align-vertical-bottom")
        self.actionAlignBottom.setIcon(icon)
        self.actionAlignBottom.setObjectName("actionAlignBottom")
        self.actionAlignVertical = QtGui.QAction(parent=MainWindow)
        icon = QtGui.QIcon.fromTheme("align-vertical-center")
        self.actionAlignVertical.setIcon(icon)
        self.actionAlignVertical.setObjectName("actionAlignVertical")
        self.actionAlignHorizontal = QtGui.QAction(parent=MainWindow)
        icon = QtGui.QIcon.fromTheme("align-horizontal-center")
        self.actionAlignHorizontal.setIcon(icon)
        self.actionAlignHorizontal.setObjectName("actionAlignHorizontal")
        ...
        self.toolBar.addAction(self.actionAlignTop)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.resourcePlaceholderText.setText(_translate("MainWindow", "<h1>Drop resources here</h1>"))
        self.resourcePlaceholderBody.setText(_translate("MainWindow", "Drop images here, or select images by pressing the Add Resource button."))
        ...
        self.actionDelete.setShortcuts([QtGui.QKeySequence("Backspace"), QtGui.QKeySequence("Delete")])
        ...
        self.actionAlignLeft.setToolTip(_translate("MainWindow", "Align Left"))
        self.actionAlignTop.setText(_translate("MainWindow", "AlignTop"))
        self.actionAlignTop.setToolTip(_translate("MainWindow", "Align Top"))
        self.actionAlignRight.setText(_translate("MainWindow", "AlignRight"))
        self.actionAlignRight.setToolTip(_translate("MainWindow", "Align Right"))
        self.actionAlignBottom.setText(_translate("MainWindow", "AlignBottom"))
        self.actionAlignBottom.setToolTip(_translate("MainWindow", "Align Bottom"))
        self.actionAlignVertical.setText(_translate("MainWindow", "AlignVertical"))
        self.actionAlignVertical.setToolTip(_translate("MainWindow", "Align Vertical"))
        self.actionAlignHorizontal.setText(_translate("MainWindow", "AlignHorizontal"))
        self.actionAlignHorizontal.setToolTip(_translate("MainWindow", "Align Horizontal"))
