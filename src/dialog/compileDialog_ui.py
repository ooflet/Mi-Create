...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        sizePolicy1.setHeightForWidth(self.watchfaceName.sizePolicy().hasHeightForWidth())
        self.watchfaceName.setSizePolicy(sizePolicy1)

        self.verticalLayout_4.addWidget(self.watchfaceName)
        ...
        sizePolicy1.setHeightForWidth(self.thumbnailLocation.sizePolicy().hasHeightForWidth())
        self.thumbnailLocation.setSizePolicy(sizePolicy1)

        self.verticalLayout_4.addWidget(self.thumbnailLocation)
