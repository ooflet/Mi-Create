...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_6.setText(_translate("Dialog", "Project location"))
        self.label_5.setText(_translate("Dialog", "Watchface binary (.bin, .face)"))
        self.label_4.setText(_translate("Dialog", "Open Binary..."))
