# Form implementation generated from reading ui file 'c:\Users\Justin\Mi-Create\src\dialog\unpackDialog.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.thumbnailLocation, 4, 0, 1, 1)
        ...
        self.folderShow = QtWidgets.QToolButton(parent=self.page_3)
        ...
        self.gridLayout.addWidget(self.folderShow, 2, 1, 1, 1)
        self.folderShow_2 = QtWidgets.QToolButton(parent=self.page_3)
        self.folderShow_2.setText("")
        self.folderShow_2.setIcon(icon)
        self.folderShow_2.setObjectName("folderShow_2")
        self.gridLayout.addWidget(self.folderShow_2, 4, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_6.setText(_translate("Dialog", "Unpack location"))
        self.label_5.setText(_translate("Dialog", "Watchface binary (.FACE)"))
        self.label_4.setText(_translate("Dialog", "Unpack project..."))
        self.label.setText(_translate("Dialog", "Unpack project..."))
        self.label_2.setText(_translate("Dialog", "Unpacking project..."))
        self.label_3.setText(_translate("Dialog", "Unpack results..."))
